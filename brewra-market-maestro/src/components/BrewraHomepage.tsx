...
import { ChevronRight, ChevronDown, Mail, Phone, ExternalLink, Target, Users, Zap, Network, Brain, ArrowRight, Search, FileText, Rocket, TrendingUp, Shield, Globe, Clock, Trophy, Contact, MapPin, Menu, X } from 'lucide-react';
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent className="bg-slate-900 text-white border border-slate-700 shadow-lg">
                  <DropdownMenuItem className="hover:bg-slate-800 focus:bg-slate-800 text-white hover:text-white focus:text-white transition-colors">
                    <a href="/blogs" className="w-full text-white">Blogs</a>
                  </DropdownMenuItem>
                  <DropdownMenuItem className="hover:bg-slate-800 focus:bg-slate-800 text-white hover:text-white focus:text-white transition-colors">
                    <a href="/media" className="w-full text-white">Media</a>
                  </DropdownMenuItem>
                </DropdownMenuContent>
              </DropdownMenu>
              ...
              <a href="https://calendly.com/brewra_ventures/discovery-call" target="_blank" rel="noopener noreferrer">
                <Button size="sm" className="bg-brewra-blue hover:bg-brewra-blue-dark text-white border-brewra-blue transition-colors">
            ...
            <div className="md:hidden border-t border-white/10 bg-black/95 backdrop-blur-sm">
              <div className="px-4 py-6 space-y-4">
                ...
                <div className="pt-4 border-t border-white/10">
                  <a href="https://calendly.com/brewra_ventures/discovery-call" target="_blank" rel="noopener noreferrer">
                    <Button size="sm" className="w-full bg-brewra-blue hover:bg-brewra-blue-dark text-white border-brewra-blue transition-colors">
                      Book a Strategy Call
                    </Button>
                  </a>
                </div>
